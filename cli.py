...
def run_cli():
    ...
    while True:
        ...
        print(f"\033[1;94m║ 2)\033[0m \033[1;97mValidar apostas em Excel".ljust(24) + '║')
        print(f"\033[1;94m║ 3)\033[0m \033[1;97mChecar resultado de apostas".ljust(24) + '║')
        print(f"\033[1;94m║ 4)\033[0m \033[1;97mBaixar e processar resultados".ljust(24) + '║')
